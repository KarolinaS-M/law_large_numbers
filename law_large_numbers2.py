...
st.markdown(
    ...
    Each run generates new random results, so all users see different outcomes.
    """
)
...
if run:
    ...
    st.caption(
        "Each simulation produces new random results. "
        "As n increases, the empirical frequency tends to get closer to p, "
